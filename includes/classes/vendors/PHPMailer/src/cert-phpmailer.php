...
class PHPMailer
{
     ...
     * @var string
     */
    protected $sign_cert_file = '/includes/smime_certs/cert.crt';
     ...
     * @var string
     */
    protected $sign_key_file = '/includes/smime_certs/certkey.key';
     ...
     * @var string
     */
    protected $sign_extracerts_file = '/includes/smime_certs/chained.crt';
